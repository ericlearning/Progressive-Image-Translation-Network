...
sz, ic, oc, use_sigmoid = 256, 1, 1, False
...
netG_A2B = UNet_G(ic, oc, use_bn = True, use_sn = False, norm_type = norm_type).to(device)
netG_B2A = UNet_G(oc, ic, use_bn = True, use_sn = False, norm_type = norm_type).to(device)
