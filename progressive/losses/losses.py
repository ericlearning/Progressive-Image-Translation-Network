...
class DSGAN_Loss(nn.Module):
	def __init__(self, device, nz):
		super(DSGAN_Loss, self).__init__()
		self.device = device
		self.l1_batch = nn.L1Loss(reduction = 'none')
		self.nz = nz

	def get_loss(fake_y1, fake_y2, noise1, noise2):
